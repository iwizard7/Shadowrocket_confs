...
- **Proxy Groups**: Правила привязаны к группам YouTube-Group, Gaming-Group и AUTO. Группа AI-Group сохранена в конфигурации, но по умолчанию трафик ИИ направлен в AUTO для бесшовной работы без переименования прокси-серверов.
